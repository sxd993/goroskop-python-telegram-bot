...
def review_prompt() -> str:
    return (
        "Три дара Высших Сил ждут тебя,не забудь оставить обратную связь ,чтобы "
        "принять участие в розыгрыше !\n\n"
        "Призы :\n\n"
        "1. Полный расклад  Вашей Судьбы на 2026 год. Не просто прогноз — это личная "
        "карта мироздания по месяцам и сферам жизни (стоимостью 35.000р).\n"
        "Личная жизнь\n"
        "Работа\n"
        "Деньги\n"
        "Здоровье\n"
        ...
        "На 12 месяцев !\n"
        "2. Волшебный Ларец . Физическое воплощение магии, что будет работать на вас "
        "весь год:\n"
        "   · Авторская колода Таро, заряженная энергией создателя.\n"
        "   · Набор свечей для очищения и притяжения.\n"
        "   · Благовония, меняющие пространство.\n"
        "   · Берегиня-мотанка — ваш личный страж очага и удачи.\n\n"
        "3. Место в Рождественском Обряде. Не наблюдение, а со-творение. Вместе мы "
        "зажжем огни и сплетем наступающий год из нитей света, желаний и древней силы.\n\n"
        "Не дайте шуму мира заглушить этот тихий зов. Ваша Вселенная стучится. "
        "Откликнитесь пока двери между мирами приоткрыты лишь для вас.выиграть "
